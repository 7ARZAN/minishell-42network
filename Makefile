...
PARSING_SRCS	=	parsing/command_splitter.c parsing/struct_cmd.c parsing/argument_splitter.c \
					parsing/redirection_utils.c parsing/variable_expansion.c parsing/heredoc_handler.c \
					parsing/parser.c parsing/quote_removal.c parsing/argument_utils.c \
